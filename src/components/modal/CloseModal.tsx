...
const CloseEditor = () => {
   ...
   const onNavigate = useCallback(() => {
      ...
      // close modal
      return onClose();
   }, [onClose, restFormState, router]);

   return (
      <Transition appear show={modalStateValue.isOpen} as={Fragment}>
                     ...
                     <Dialog.Panel className="w-full max-w-2xl bg-base-100 rounded-xl">
                        ...
                        <div className="p-4 md:p-8">
                           ...
                           <div className="flex gap-2 pt-5 join justify-self-start max-sm:join-vertical">
                              <Button variant="error" className="text-white" onClick={onNavigate}>
                                 Yes, leave the page
                              </Button>
